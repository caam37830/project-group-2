...
plt.plot(np.arange(0,76,1),dfc-dfd-dfr,label = "infect")
plt.plot(np.arange(0,76,1),dfd+dfr,label = "remove")
plt.plot(np.arange(0,76,1),vstackconnect[0],label = "simulated infect")
plt.plot(np.arange(0,76,1),vstackconnect[1],label = "simulated remove")
plt.legend()
plt.show()
